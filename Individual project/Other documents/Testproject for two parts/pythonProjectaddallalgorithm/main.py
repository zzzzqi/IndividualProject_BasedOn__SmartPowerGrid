...
def dynamic_env(read_file):
    ...
    def data_exploration(dr_value, clustering_value,
        ...
        check_multiple_selection = pn.widgets.RadioButtonGroup(
            name='Radio Button Group', options=['multiple events selection', 'Single events selection'],
            button_type='default', width=600)

        # Build a Button to display the details of multiple selected events
        display_selected_events_in_event_page_button = pn.widgets.Button(
            name="Display selected events",
            button_type="success",
            width=200,
            margin=(0, 0, 0, 0)
        ...
        # Option B: PCA and no clustering algo
            ...
            return pn.Tabs(
                ...
                ("Selected event", pn.bind(get_event_single_selection, vega_pane.selection.param.event_id)),
                ("Similar events", pn.bind(get_similar_events_single_selection, vega_pane.selection.param.event_id))
            )
